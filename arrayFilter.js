// Challenge: using the Array.prototype.filter() method, filter through the presidents array and console.log only the 
// presidents who were born in the 1900's.
...
// console.log(presidents[0].year);

// let checkFor1900s = (arr) => {
//     return arr.year >= 1900 && arr.year < 2000
// }
// console.log(presidents.filter(checkFor1900s));

let newPresArray = presidents.filter(arr => arr.year >= 1900 && arr.year < 2000);
